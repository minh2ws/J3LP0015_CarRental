        ...
        try {
            ...
            if (session != null) {
                ...
                if (role.equals("ADMIN"))
                    dao.getListOrderByAdmin();
                else
                    dao.getListOrderByEmail(email);
            ...
            log("OrderHistoryServlet _ SQLException: " + e.getMessage());
        } catch (NamingException e) {
            log("OrderHistoryServlet _ NamingException: " + e.getMessage());
        } finally {
