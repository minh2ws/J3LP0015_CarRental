            ...
            if (session != null) {
                ...
                if (cart != null) {
                    ...
                    if (cart.getDiscount() != 0) {
                        double totalPriceDiscounted = cart.getTotalPriceOfCartHasDiscounted();
                        request.setAttribute("TOTAL_PRICE_DISCOUNTED", totalPriceDiscounted);
                    } else
                        request.setAttribute("TOTAL_PRICE_DISCOUNTED", totalPrice);
